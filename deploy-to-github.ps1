# ============================================================
# SLITHIFY - GitHub + Vercel Deployment Script
# Double-click this file or run in PowerShell terminal
# ============================================================

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "   SLITHIFY - GitHub Deployment Setup  " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
git add .
git commit -m "✨ Slithify - Playful cartoon arcade snake game" 2>&1
if ($LASTEXITCODE -ne 0) {
    ...
    git add .
    git commit -m "✨ Slithify - Playful cartoon arcade snake game"
}
